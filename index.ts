...
import { IProvider, INetwork, IConnectorMessage, IEvent, IEventError, INativeCurrency } from "./interface";

export class GameStop implements AbstractConnector {
  public connector: any;
  public name: string = 'GameStop';
