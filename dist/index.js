...
var MetaMask = /** @class */ (function () {
    ...
    MetaMask.prototype.ethRequestAccounts = function () {
        return this.connector.request({ method: "eth_requestAccounts" });
    };
    MetaMask.prototype.getChainId = function () {
        return this.connector.request({ method: "eth_chainId" });
    };
    MetaMask.prototype.checkNet = function () {
    ...
    MetaMask.prototype.eventSubscriber = function () {
        var _this = this;
     ...
     */
    MetaMask.prototype.getAccounts = function () {
        var _this = this;
        var error = {
            code: 3,
            message: {
    ...
    MetaMask.prototype.disconnect = function () {
