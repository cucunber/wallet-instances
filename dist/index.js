...
var GameStop = /** @class */ (function () {
     ...
     */
    GameStop.prototype.connect = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (typeof window.gamestop !== 'undefined') {
                _this.connector = window.gamestop;
                resolve({
                    code: 1,
                    connected: true,
    ...
    GameStop.prototype.ethRequestAccounts = function () {
        return this.connector.request({ method: 'eth_requestAccounts' });
    };
    GameStop.prototype.getChainId = function () {
        return this.connector.request({ method: 'eth_chainId' });
    };
    GameStop.prototype.checkNet = function () {
    ...
    GameStop.prototype.eventSubscriber = function () {
        var _this = this;
     ...
     */
    GameStop.prototype.getAccounts = function () {
        var _this = this;
        var error = {
            code: 3,
            message: {
    ...
    GameStop.prototype.disconnect = function () {
