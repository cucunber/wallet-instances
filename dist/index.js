...
var WalletsConnect = /** @class */ (function () {
    /**
     * Connect wallet to application using connect wallet via WalletConnect by scanning Qr Code
     * in your favourite crypto wallet.
     */
    function WalletsConnect(network) {
        this.name = "WalletConnect";
        this.chainID = network.chainID;
    }
    WalletsConnect.prototype.getChainId = function () {
        return this.connector.request({ method: "eth_chainId" });
    };
    WalletsConnect.prototype.checkNet = function () {
        return __awaiter(this, void 0, void 0, function () {
            var chainsMap, chainIDMap, result, currentChain, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chainsMap = helpers_1.parameters.chainsMap, chainIDMap = helpers_1.parameters.chainIDMap;
                        result = {
                            chain: true
                        };
                        _a.label = 1;
                    ...
                    case 2:
                        ...
                        if (this.chainID !== parseInt(currentChain)) {
                            result.chain = false;
                            result.error = (0, errors_1.chainError)("Please set network: ".concat(chainsMap[chainIDMap[this.chainID]].name, "."));
     ...
     */
    WalletsConnect.prototype.connect = function (provider, network) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var providerConfig, isProviderRpcEmpty;
                        var _a, _b;
                        var _this = this;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    providerConfig = __assign(__assign({}, initialProviderConfig), provider);
                                    isProviderRpcEmpty = !provider.provider;
                                    if (providerConfig.useProvider === "rpc" && isProviderRpcEmpty) {
                                        providerConfig.provider.rpc = (_a = {}, _a[network.chainID] = network.rpc, _a);
                                    }
                                    this.connector = new web3_provider_1["default"]((_b = {},
                                        _b[providerConfig.useProvider] = providerConfig.provider[providerConfig.useProvider],
                                        _b));
    ...
    WalletsConnect.prototype.getAccounts = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.checkNet().then(function (netStatus) {
                if (netStatus.chain) {
